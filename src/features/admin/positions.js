...
const roles=[['executive','Executive'],['elt','ELT'],['olt','OLT'],['director','Department Director'],['staff','Department staff'],['external','Board / External']];
const features=[['strategic','2030 Plan Scorecard'],['annual','Annual Scorecard'],['metrics','Record progress'],['weekly','Weekly Accountability'],['learn','Learn'],['myDashboard','Profile and working dashboard (off by default)']];
